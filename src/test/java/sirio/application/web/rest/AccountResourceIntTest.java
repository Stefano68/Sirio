package sirio.application.web.rest;

import sirio.application.config.Constants;
import sirio.application.SirioApp;
import sirio.application.domain.Authority;
import sirio.application.domain.User;
import sirio.application.repository.AuthorityRepository;
import sirio.application.repository.UserRepository;
import sirio.application.security.AuthoritiesConstants;
import sirio.application.service.MailService;
import sirio.application.service.dto.UserDTO;
import sirio.application.web.rest.errors.ExceptionTranslator;
import sirio.application.web.rest.vm.KeyAndPasswordVM;
import sirio.application.web.rest.vm.ManagedUserVM;
import sirio.application.service.UserService;
...
@SpringBootTest(classes = SirioApp.class)
