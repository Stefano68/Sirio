package sirio.application.repository;

import sirio.application.SirioApp;
import sirio.application.config.Constants;
import sirio.application.config.audit.AuditEventConverter;
import sirio.application.domain.PersistentAuditEvent;
...
import static sirio.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
